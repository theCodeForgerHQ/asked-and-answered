...
describe('Ledger SQLite on-disk integration', () => {
  ...
  test('writes and reads events from a real SQLite file', () => {
    ...
    const event: DomainEvent = {
      ...
      citations: [{ permalink: 'https://s.example/p', channelId: 'C1', ts: '1.0', snippet: 'AES-256' }],
  ...
  test('detects tampering in the SQLite file', () => {
    ...
    // Re-open and mutate the underlying DB directly.
    const raw = require('better-sqlite3')(path);
